...
import com.android.leo.awsomecustomview.R;
import com.android.leo.awsomecustomview.utils.MeasureUtils;
...
public class MatrixImageView extends ImageView {
    ...
    private void init() {
        ...
        bitmap = Bitmap.createScaledBitmap(bitmap, MeasureUtils.getScreenWidth((Activity) mContext), MeasureUtils.getScreenHeight((Activity) mContext), true);
